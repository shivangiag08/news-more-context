...
data['cleaned_article'] = data['article'].apply(text_cleaner)
...
x_train,x_test,y_train,y_test = tts(data['cleaned_article'],data['cleaned_summary'],test_size=0.1, shuffle=True, random_state=111)
...
def initialize_weights(model):
    for name, param in model.named_parameters():
        if 'weight' in name:
            init.normal_(param, mean=0.0, std=0.02)  # Adjust mean and std as needed

# Assuming net is your Transformer model
...
torch.save(net.state_dict(), 'transformer_model.pth')